...
const ICONS = {
  python: <SiPython className="mx-auto" size={defaultIconSize} color="#4B8BBE" />,
  javascript: <SiJavascript className="mx-auto" size={defaultIconSize} color="#f0db4f" />,
  go: <SiGo className="mx-auto" size="55" color="#29BEB0" />,
  ruby: <SiRuby className="mx-auto" size={defaultIconSize} color="#820C02" />,
  java: <SiJava className="mx-auto" size={defaultIconSize} color="#f89820" />,
  php: <SiPhp className="mx-auto" size={defaultIconSize} color="#474A8A" />,
